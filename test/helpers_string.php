<main>
	...
	<section id="arrayToString">
		...
		<ul>
			...
			<li><i>bool <b>brackets</b></i>: true si queremos que aparezcan
				corchetes en los extremos del string resultante.</li>
			<li><i>bool <b>associative</b></i>: true si queremos mostrar los
				pares de clave => valor, false para mostrar solamente los valores.</li>
			<li><i>string <b>separator</b></i>: separador entre valores.</li>
			<li><i>string <b>keyValueSeparator</b></i>: separador en los pares de
				clave => valor.</li>
		</ul>
		...
		<p>Si un array contiene otros arrays, también pasa a string los arrays
			internos:</p>

		<code>$lista = ['dias'=>['lunes','martes'],
			'plato'=>['primero'=>'lechuga', 'segundo'=>'lomo']];</code>
