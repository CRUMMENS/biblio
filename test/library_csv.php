<main>
	...
	<section>
		...
		<p>
			Intentando convertir a CSV los usuarios decuperados desde la BDD.
			Para ello podemos hacer
			<code>CSV::encode(User::all())</code>
			.
		</p>
		...
		<p>
			Ahora con puntos y coma y doble salto de línea. Para ello haremos
