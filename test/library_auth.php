...
?>
	...
	<section>
		...
		<p>
			Hay que comentar y descomentar las comprobaciones que se encuentran
			en el código
			<code>PHP</code>
			a continuación, puesto que lanzan excepciones. Si se produce un error
			de autorización, aparecerá un <b>mensaje en rojo</b> justo debajo de
			este párrafo. La descripción del mensaje tiene que ser coherente con
