...
class Base implements TemplateInterface
{
     ...
     */
    public function header(?string $title = NULL, ?string $subtitle = NULL)
    {
        return "
            <header>
                <figure>
    ...
    public function menu()
    {
        ...
        $html .= "<li><a href='/'>Libros</a></li>";
        $html .= "<li><a href='/'>Temas</a></li>";
    ...
    {
        return ACCEPT_COOKIES && ! HttpCookie::get(ACCEPT_COOKIES_NAME) ? "<div class='modal'>
     ...
     *
     * @param array $migas
     *            array asociativo con las entradas que deben aparecer en el migas.
     *            
     * @return string HTML del elemento migas.
     */
    public function breadCrumbs(array $migas = []): string
    {
        $migas = [
            "Inicio" => "/"
        ] + $migas; // coloca el enlace a "inicio"
    ...
    {
        return ($mensaje = Session::getFlash('success')) ? "<div class='modal' onclick='this.remove()'>
    ...
    {
        return ($mensaje = Session::getFlash('warning')) ? "<div class='modal' onclick='this.remove()'>
    ...
    {
        return ($mensaje = Session::getFlash('error')) ? "<div class='modal' onclick='this.remove()'>
     ...
     *
     * @param array $fields
     *            lista de campos para el desplegable con el campo de búsqueda.
     * @param array $orders
     *            lista de campos para el desplegable con el orden de los resultados.
     * @param string $selectedField
     *            campo seleccionado por defecto en el desplegable con los campos de búsqueda.
     * @param string $selectedOrder
     *            campo seleccionado por defecto en el desplegable con los campos de ordenación.
     * @param string $action
     *            URL donde se enviará el formulario de búsqueda.
     *            
     * @return string HTML con el formulario de búsqueda.
     */
    public function filterForm(array $fields = [], array $orders = [], string $selectedField = '', string $selectedOrder = '', ?string $action = NULL)
    {
     ...
     *
     * @param Filter $filtro
     *            objeto Filter con el filtro aplicado.
     * @param string $action
     *            URL a la que se debe enviar el formulario. Normalmente será a la misma operación de listado en la que nos encontramos.
     *            
     * @return string
     */
    public function removeFilterForm(Filter $filter, ?string $action = NULL)
    {
    ...
    /**
     * Crea el formulario para exportar resultados a distintos formatos.
     * En el controlador
        ...
        <footer class='flex-container left drop-shadow'>
            ...
            <div class='flex4 p2'>
                ...
                <p> Desarrollado por <a href='https://robertsallent.com'> Robert Sallent.</a></p>
                 <p>Editado por <b>Carmen Rummens <b>. </p>
            </div>
