...
class ExampleController extends Controller
{
     ...
     *
     * @param string $method
     *            operación a ejecutar (nombre del fichero en la carpeta example).
     * @param array $arguments
     *            parámetros adicionales, sin uso por el momento.
     *            
     * @return Response
     */
    public function __call(string $method, array $arguments = []): // sin uso por el momento
    Response
    {
        ...
        if ($method == "index") {
            ...
            $examples = FileList::get(EXAMPLE_FOLDER, [
                'html'
            ]);
