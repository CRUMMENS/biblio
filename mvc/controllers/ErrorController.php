...
class ErrorController extends Controller
{
     ...
     *
     * @param int $id
     *            identificador del error a eliminar.
     * @return Response
     ...
     *            tipo de fichero, de momento puede ser "errors" o "login".
     * @return Response
     */
    public function download(string $fileType = 'errors'): Response
    {
        ...
        switch ($fileType) {
            case 'errors':
                $response = new FileResponse(ERROR_LOG_FILE);
                break;
            case 'login':
                $response = new FileResponse(LOGIN_ERRORS_FILE);
                break;
        }
     ...
     *
     * @param string $fileType
     *            tipo de fichero, puede ser "errors" o "login".
     * @return Response
     */
    public function erase(string $fileType = 'errors'): Response
    {
        ...
        switch ($fileType) {
            case 'errors':
                $ok = File::remove(ERROR_LOG_FILE);
                break;
            case 'login':
                $ok = File::remove(LOGIN_ERRORS_FILE);
                break;
            default:
                $ok = false;
        }
