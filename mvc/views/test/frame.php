...
<meta name="description"
	content="Test de <?= $test ?> en <?= APP_NAME ?>">
...
try {
    ...
    ?>
		...
		<h2>ERROR</h2>
		<p>
			Se produjo un error en el test <b><i><?= $test ?></i></b> con el
			siguiente mensaje: <i><?= $e->getMessage() ?></i>
		</p>
		<p>Revisa el código que se encuentra justo en este punto del test para
			solucionarlo.</p>
	</div>  
    	<?php } ?>
