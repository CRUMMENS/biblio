...
<body>
		...
		<form class="w50 bloque-centrado" method="POST" autocomplete="off"
			id="login" action="/Forgotpassword/send">

			<h2>Recuperación de password</h2>
			<p class="justificado">
				Rellena este formulario para recibir una nueva clave en tu <i>email</i>
				con la que podrás acceder a la aplicación. Recuerda que debes
				cambiarla lo antes posible.
			</p>

			<div style="margin: 10px;">
				<label for="email">email:</label> <input type="email" name="email"
					id="email" value="<?= old('email') ?>" required> <br> <label
					for="phone">teléfono:</label> <input type="text" name="phone"
