...
class App extends Kernel
{
    ...
    public function boot(): Response
    {
        try {
            ...
            $controller = empty($url[0]) ? DEFAULT_CONTROLLER : ucfirst(strtolower(array_shift($url))) . 'Controller';
            ...
            $method = empty($url[0]) ? DEFAULT_METHOD : strtolower(array_shift($url));
            ...
            $mensaje = DEBUG ? (new DebugInformation($t, $controller, $method, $url))->toHtml() : "No se pudo realizar la operación solicitada.";
