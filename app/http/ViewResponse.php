...
class ViewResponse extends Response
{
     ...
     * @param array $params
     *            array asociativo con los parámetros a pasar a la vista
     * @param int $httpCode
     *            código HTTP
     * @param string $status
     *            frase correspondiente al estado
     */
    public function __construct(string $name, array $params = [], int $httpCode = 200, string $status = 'OK')
    {
