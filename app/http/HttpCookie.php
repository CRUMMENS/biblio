...
class HttpCookie
{
     ...
     * @param string $path
     *            ruta para la que es válida la cookie en el servidor
     * @param string $domain
     *            dominio
     * @param bool $secure
     *            si solamente se puede transferir por https
     * @param bool $httpOnly
     *            si no debe ser modificada en el lado del cliente
     */
    public function __construct(private string $name, private string $value = "", private int $expires = 0, private string $path = "", private string $domain = "", private bool $secure = false, private bool $httpOnly = false)
    {}
