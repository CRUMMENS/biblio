...
class RedirectResponse extends Response
{
     ...
     */
    public function __construct(string $url = '/', int $delay = 0, int $httpCode = 302, string $status = 'FOUND')
    {
     ...
     *
     * @param bool $show
     *            permite indicar si se quiere mostrar el mensaje de redirección
     */
