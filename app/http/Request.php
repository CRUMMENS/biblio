...
class Request
{
     ...
     *
     * @param string $url
     *            cadena de texto a buscar al inicio de la ruta.
     ...
     * @param string $method
     *            método HTTP por el que debe llegar.
     *            
     * @return bool true si el parámetro llega, false en caso contrario.
     */
    public function has(string $name, string $method = 'POST'): // POST, GET o COOKIE
     ...
     */
    public function post(string $name): ? // nombre del campo a recuperar
    string
    {
     ...
     * @return string|NULL valor recuperado o NULL si no existe el parámetro.
     */
    public function get(string $name): ? // nombre del parámetro a recuperar
    string
    {
     ...
     *
     * @param string $name
     *            nombre de la cookie a recuperar.
     *            
     ...
     *
     * @param string $name
     *            nombre del encabezado a recuperar.
     *            
     ...
     */
    public function file(string $key, int $maxSize = UPLOAD_MAX_SIZE, // definido en config.php
    array $mimes = []): ?UploadedFile
    {
    ...
    /**
     * Recupera los datos en el body de la petición.
     * Los datos no son
     ...
     *
     * @param string $class
     *            clase a la que mapear los elementos de pimer nivel dentro del array retornado
     *            
     * @return array|NULL retorna un array de objetos creado a partir del JSON
     */
    public function fromJson(string $class = 'stdClass'): ?array
    {
     ...
     */
    public function fromXML(string $class = 'stdClass'): ?array
    {
