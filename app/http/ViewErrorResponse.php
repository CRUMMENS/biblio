...
class ViewErrorResponse extends ViewResponse
{
     ...
     *
     * @param Throwable $t
     *            error o excepción que produjo la aplicación
     * @param int $httpCode
     *            código HTTP
     * @param string $status
     *            frase correspondiente al estado
     * @param string $message
     *            mensaje personalizado, que susituiría al que viene con la excepción
     */
    public function __construct(Throwable $t = null, int $httpCode = 500, string $status = 'INTERNAL SERVER ERROR', string $message = null)
    {
        // llama al constructor de la clase padre
        parent::__construct('error', // vista de error por defecto
        [
