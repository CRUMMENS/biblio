...
class Response
{
     ...
     *            código HTTP
     * @param string $status
     *            frase correspondiente al estado
     * @param string $content
     *            contenido en el body de la respuesta
     */
    public function __construct(string $contentType = 'text/html', int $httpCode = 200, string $status = 'OK')
    {
     ...
     *            valor de la cookie
     * @param int $expires
     *            tiempo de expiración, 0 para cookie de sesión.
     * @param string $path
     *            ruta para la que se debe adjuntar la cookie
     * @param string $domain
     *            dominio
     * @param bool $secure
     *            transmitir solo por https
     * @param bool $httponly
     *            accesible solo en el lado del servidor
     *            
     */
    public static function addCookie(string $name, string $value = "", int $expires = 0, string $path = "", string $domain = "", bool $secure = false, bool $httpOnly = false)
    {
        ...
        self::$cookies->push(new HttpCookie($name, $value, $expires, $path, $domain, $secure, $httpOnly));
    }
     ...
     *
     */
    public static function addHeader(string $header, bool $replace = true, int $responseCode = 0)
    {
        ...
        self::$headers->push(new HttpHeader($header, $replace, $responseCode));
    }
     ...
     *
     * @param Throwable $t
     *            la excepción o error producidos
     *            
