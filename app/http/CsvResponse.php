...
class CsvResponse extends ApiResponse
{
     ...
     * @param string $status
     *            mensaje de estado para la respuesta
     */
    public function __construct(array $data = [], string $fieldSeparator = ",", string $entitySeparator = "\n", bool $columnHeaders = true, int $httpCode = 200, string $status = 'OK')
    {
