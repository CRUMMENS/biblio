 ...
 *            mensaje a mostrar al finalizar la ejecución.
 */
 ...
 *            array a convertir.
 * @param bool $brackets
 *            mostrar corchetes rodeando el array?
 * @param bool $associative
 *            se trata de un array asociativo?
 * @param string $separator
 *            separador de elementos, por defecto la coma y un espacio.
 * @param string $keyValueSeparator
 *            separador entre clave y valor.
 *            
 * @return string representación del array a modo texto.
 */
function arrayToString(array $lista, bool $brackets = true, bool $associative = true, string $separator = ", ", string $keyValueSeparator = " => "): string
{
    $texto = '';
 ...
 *            texto a convertir
 * @param bool $edges
 *            coloca las etiquetas <p> y </p> al inicio y final del texto (por defecto true).
 * @param bool $collapse
 *            une múltiples espacios en blanco en uno solo.
 *            
 * @return string texto metido en párrafos.
 */
function paragraph(string $text = '', bool $edges = true, bool $collapse = true): string
{
 ...
 *
 * @param string $name
 *            nombre de la vista, sin la extensión.
 * @param array $parameters
 *            array asociativo con los datos que se le pasan a la vista.
 * @param int $httpcode
 *            código HTTP de la respuesta
 * @param string $status
 *            frase de estado HTTP
 *            
 *            
 * @return ViewResponse
 *
 ...
 */
function view(string $name, array $parameters = [], int $httpCode = 200, string $status = 'OK'): ViewResponse
{
 ...
 * @param Throwable $t
 *            error o excepción producida, para preparar mejor la respuesta
 *            
 * @return Response
 *
 ...
 *        
 */
function abort(int $code = 500, string $status = 'INTERNAL SERVER ERROR', string $message = '', Throwable $t = null): Response
{
 ...
 *
 * @param string $url
 *            URL a la que queremos redireccionar.
 * @param int $delay
 *            retardo en la redirección.
 * @param int $httpCode
 *            código HTTP
 * @param string $status
 *            frase de estado HTTP
 ...
 * @param bool $die
 *            finalizar la ejecución tras la redirección?
 *            
 * @return RedirectResponse
 */
function redirect(string $url = '/', int $delay = 0, int $httpCode = 302, string $status = 'FOUND'): RedirectResponse
{
 ...
 *            nombre del input a recuperar.
 * @param string $dbValue
 *            para las operaciones de edición, valor antiguo de la BDD.
 *            
 ...
 *            valor a comprobar.
 * @param bool $default
 *            si debe estar marcado por defecto.
 *            
 * @return string checked o cadena vacía.
 */
function oldChecked(string $inputName, string $value, bool $default = false): string
{
