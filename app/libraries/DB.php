...
abstract class DB
{
     ...
     *
     * @param string $tabla
     *            tabla sobre la que queremos realizar la operación.
     * @param string $operacion
     *            operación a realizar.
     * @param string $campo
     *            campo sobre el que se realizará la operación.
     *            
     ...
     *
     * @param string $tabla
     *            tabla donde realizar la operación
     * @param array $totales
     *            array asociativo con el listado de campos y totales, por ejemplo ['id' => 'COUNT'] para contar ID
     * @param array $agruparPor
     *            array indexado con la lista de campos para realizar el agrupado.
     *            
     * @return array de objetos stdClass con los resultados.
     */
    public static function groupBy(string $tabla, array $totales = [
        'id' => 'COUNT'
    ], array $agruparPor = []): array
    {
