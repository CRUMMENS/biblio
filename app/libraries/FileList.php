...
class FileList
{
     ...
     *            directorio de trabajo, por defecto el directorio actual
     */
     ...
     *
     * @param string $directory
     *            directorio al que queremos cambiar
     */
     ...
     *            expresión regular o lista de extensiones
     * @param bool $specialEntries
     *            permite indicar si queremos que aparezcan el . y el ..
     *            
     * @return array listado de entradas de directorio coincidentes con los filtros aplicados, ordenadas alfabéticamente
     */
    public function getEntries(string|array|NULL $matches = "/.*/", bool $specialEntries = false): array
    {
     ...
     *            expresión regular o array de extensiones
     *            
     * @return array lista de entradas coincidentes
     */
    public function getFiles(array|string|NULL $matches = "/.*/"): array
    {
     ...
     * @return array lista de entradas coincidentes
     */
    public static function get(string $directorio = ".", array|string|NULL $matches = "/.*/", bool $specialEntries = false): array
    {
     ...
     * @return array lista de entradas coincidentes
     */
    public static function files(string $directorio = ".", array|string|NULL $matches = "/.*/"): array
    {
