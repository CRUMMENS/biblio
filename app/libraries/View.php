...
class View
{
     ...
     *
     * @param string $name
     *            nombre del parámetro a eliminar
     */
    ...
    public function load()
    {
        ...
        try {
            ...
            $message = DEBUG ? "<p>ERROR en la vista <b>" . VIEWS_FOLDER . "/$this->name.php</b>.</p>
             <p>INFORMACIÓN ADICIONAL: " . $e->getMessage() . "</p>" : "Error al cargar la página.";
