...
class Session
{
     ...
     *            categoría o tipo del mensaje.
     * @param string $mensaje
     *            mensaje a flashear.
     */
    public static function flash(string $categoria = 'message', // categoria, por ejemplo success o error
     ...
     */
    public static function getFlash(string $categoria = 'message'): ? // categoria, por ejemplo success o error
    string
    {
     ...
     */
    public static function set(string $name, // nombre de la variable de sesión a crear
     ...
     *
     * @param string $name
     *            nombre de la variable a olvidar.
     */
