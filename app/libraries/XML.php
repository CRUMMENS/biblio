...
class XML
{
     ...
     *            XML a validar.
     * @param string $schema
     *            esquema contra el que se quiere realizar la validación.
     *            
    ...
    public static function validateWithSchema(string $xml, string $schema): bool
    {
        $dom = new DOMDocument();
     ...
     * @param string $root
     *            nombre para el elemento raíz.
     * @param string $name
     *            nombre para cada uno de los elementos contenidos directamente dentro del elemento raíz.
     * @param string $namespace
     *            espacio de nombres a usar.
     *            
     * @return string el XML con el resultado.
     */
    public static function encode(array $list = [], string $root = 'root', string $name = null, string $namespace = "https://xml.robertsallent.com"): string
    {
     ...
     *            origen de datos XML.
     * @param string $class
     *            nombre de la clase a la que queremos mapear los objetos recuperados en primer nivel de profundidad.
     * @param bool $file
     *            para indicar si los datos llegan de fichero (true) o url (false).
     *            
     * @return array lista de objetos PHP recuperados desde el XML.
     */
    public static function decode(string $origin, string $class = 'stdClass', bool $file = true): array
    {
