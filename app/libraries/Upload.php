...
class Upload
{
     ...
     *
     * @param string $key
     *            clave de $_FILES (nombre del input).
     * @param string $folder
     *            carpeta de destino.
     * @param bool $unique
     *            generar nombre único?.
     * @param int $max
     *            tamaño max del fichero (0 ilimitado).
     * @param string $mime
     *            tipo MIME (image/jpeg, image/*, etc).
     * @param string $prefix
     *            prefijo para el nombre del fichero.
     * @param bool $returnFullRoute
     *            retornar la ruta final completa o solo el nombre del fichero.
     *            
     * @return string nombre final del fichero o ruta completa en la que queda ubicado.
     */
    public static function save(string $key = 'file', string $folder = '', bool $unique = true, int $max = 0, string $mime = '.', string $prefix = '', bool $returnFullRoute = false): string
    {
