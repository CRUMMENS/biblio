...
class JSON
{
     ...
     *
     * @param mixed $objetos
     *            los datos a pasar a JSON.
     * @param bool $exceptions
     *            permite indicar si se deben lanzar excepciones ante un fallo o no.
     * @param bool $pretty
     *            permite indicar si queremos usar tabuladores y saltos de línea para una impresión amigable.
     *            
     * @return string el texto con los datos codificados en JSON.
     */
    public static function encode($datos, bool $exceptions = true, bool $pretty = false): string
    {
        ...
        return json_encode($datos, JSON_UNESCAPED_UNICODE | JSON_UNESCAPED_SLASHES | ($exceptions ? JSON_THROW_ON_ERROR : 0) | ($pretty ? JSON_PRETTY_PRINT : 0));
    }
     ...
     *
     * @param string $json
     *            texto en JSON que queremos convertir a lista de objetos PHP.
     * @param string $class
     *            clase a la que queremos convertir los objetos de primer nivel de profindidad.
     * @param bool $exceptions
     *            permite indicar si se deben lanzar excepciones ante un fallo o no.
     *            
     * @return array el listado de objetos recuperados.
     */
    public static function decode(string $json, string $class = 'stdClass', bool $exceptions = true): ?array
    {
