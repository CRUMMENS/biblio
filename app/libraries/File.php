...
class File
{
     ...
     *
     * @param string $regexp
     *            expresión regular que usaremos para hacer match
     *            
     ...
     *
     * @param array $mimes
     *            lista de tipos MIME a comprobar
     ...
     *
     * @param string $text
     *            texto a añadir al final del fichero.
     * @param bool $newLine
     *            si queremos añadir salto de línea al final.
     *            
     ...
     *            nombre con el que se descargará el fichero. NULL para el nombre original del fichero.
     *            
     * @throws FileException si no encuentra el fichero.
     * @return string el contenido del fichero.
     */
     ...
     *            se deben lanzar excepciones?
     * @param bool $warnings
     *            se deben mostrar los warnings?
     *            
     * @return File un objeto File que referencia al nuevo fichero creado (la copia)
     */
    public function copy(string $path, bool $exception = false, bool $warnings = false): File
    {
     ...
     */
    public function move(string $path, bool $exception = false, bool $warnings = false): bool
    {
     ...
     *
     * @param bool $exception
     *            permite indicar si queremos lanzar excepciones en caso de error
     * @param bool $warnings
     *            permite indicar si queremos mostrar advertencias en caso de que las hubiera
     *            
     * @return bool
     */
    public function delete(bool $exception = false, // lanzar excepción si no puede borrar?
     ...
     *
     * @param string $path
     *            ruta donde se encuentra ubicado el fichero
     *            
     ...
     */
    public static function makeCopy(string $origin, string $destiny, bool $exception = false, bool $warnings = false): string
    {
     ...
     * @return bool si lo ha conseguido o no
     */
    public static function doMove(string $origin, string $destiny, bool $exception = false, bool $warnings = false): bool
    {
     ...
     *
     * @param string $path
     *            ruta donde se encuentra el fichero a eliminar
     * @param bool $exception
     *            permite indicar si queremos lanzar excepciones en caso de error
     * @param bool $warnings
     *            permite indicar si queremos mostrar advertencias en caso de que las hubiera
     ...
     * @return bool
     */
    public static function remove(string $path, // ubicación del fichero
