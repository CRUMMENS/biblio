...
class Log extends File
{
     ...
     *
     * @param int $maxSize
     *            tamaño máximo del fichero de LOG, 0 para ilimitado.
     */
    ...
    /**
     * Método que elimina la primera línea del fichero de LOG.
     * Se usa
     ...
     *
     * @param string $level
     *            nivel del error, por ejemplo NOTICE, WARNING, ERROR
     * @param string $message
     *            mensaje adjunto
     * @param bool $addDate
     *            permite indicar si queremos añadir la fecha en la línea
     *            
     * @return int el número de bytes escrito.
     */
    public function add(string $level = 'ERROR', string $message = 'se ha producido un error', bool $addDate = true)
    {
        $addDate ? $text = date("d/m/Y H:i:s") . " - $level - $message" : $text = "$level - $message";
     ...
     * @return int el número de bytes escrito.
     */
    public static function addMessage(string $route = '../logs/error.log', string $level = 'ERROR', string $message = 'se ha producido un error', bool $addDate = true): int
    {
