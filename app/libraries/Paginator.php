...
class Paginator
{
     ...
     *
     * @param string $url
     *            URL que estamos paginando
     * @param int $page
     *            número de página actual
     * @param int $limit
     *            número de resultados a mostrar en cada página
     * @param int $total
     *            total de resultados
     * @param string $lang
     *            idioma en el que queremos los textos en los enlaces y estadísticas
     */
    public function __construct(string $url = '/', int $page = 1, int $limit = 20, int $total = 0, string $lang = 'es')
    {
        $this->url = $url;
     ...
     *
     * @param string $divCssClasses
     *            lista de clases para el CSS del contenedor de los enlaces
     * @param string $linkCssClasses
     *            lista de clases para el CSS de los botones
     *            
     * @return string el HTML formado para imprimir directamente en la vista
     */
    public function links(string $divCssClasses = 'paginator-links', string $linkCssClasses = 'button'): string
    {

        // prepara el HTML con los enlaces para las vistas
        $resultado = "<div class='$divCssClasses'>";

        $resultado .= $this->previous ? "<a class='$linkCssClasses' href='$this->url/$this->previous'>" . self::$langs[$this->lang][0] . "</a> " : "";

        $resultado .= $this->next ? "<a class='$linkCssClasses' href='$this->url/$this->next'>" . self::$langs[$this->lang][1] . "</a> " : "";
     ...
     * @return string el HTML formado para imprimir directamente en la vista
     */
    public function numericLinks(string $divCssClasses = 'paginator-links', // clases para el CSS del contenedor
    ...
    /**
     * Método que genera los enlaces para usar en las vistas.
     * Pone enlaces numéricos y a última página y anterior.
     *
     * @param string $divCssClasses
     *            lista de clases para el CSS del contenedor de los enlaces
     * @param string $linkCssClasses
     ...
     * @return string el HTML formado para imprimir directamente en la vista
     */
    public function ellipsisLinks(string $divCssClasses = 'paginator-links', // clases para el CSS del contenedor
    string $linkCssClasses = 'button'): // clases para el CSS de los enlaces
    string
    {
        if ($this->pages < 2)
     ...
     *            lista de clases CSS para el estilo
     * @return string el código HTML listo para imprimir en las vistas
     */
    public function stats(string $cssClasses = 'paginator-stats my1'): // clases para el CSS del contenedor
    string
    {
