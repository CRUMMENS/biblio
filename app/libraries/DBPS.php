...
class DBPS extends DBPDO
{
    ...
    private static function executeStatement(string $consulta, array $bindings = []): PDOStatement
    {
    ...
    public static function select(string $consulta, string $class = 'stdClass', array $bindings = [])
    {
    ...
    public static function selectAll(string $consulta, string $class = 'stdClass', array $bindings = []): array
    {
        $stm = self::executeStatement($consulta, $bindings);
