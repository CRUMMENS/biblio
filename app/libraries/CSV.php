...
class CSV
{
     ...
     *
     * @param array $datos
     *            lista de objetos a pasar a CSV.
     * @param string $fieldSeparator
     *            separador de campos, por defecto la coma.
     * @param string $entitySeparator
     *            separador de entidades, por defecto el salto de línea
     * @param bool $columnHeaders
     *            permite indicar si queremos una primera fila con los nombres de los campos
     *            
     * @return string el texto con los datos codificados en CSV.
     */
    public static function encode(array $datos, string $fieldSeparator = ",", string $entitySeparator = "\n", bool $columnHeaders = true): string
    {
        $csv = "";
     ...
     *
     * @param string $csv
     *            texto en CSV que queremos convertir a lista de objetos PHP.
     * @param string $class
     *            clase a la que queremos convertir los objetos (por defecto stdClass).
     * @param bool $columnHeaders
     *            permite indicar si están indicados los nombres de los campos,
     *            si no lo estuvieran, los nombres de las propiedades serían genéricos.
     *            
     * @return array el listado de objetos recuperados.
     */
    public static function decode(string $csv, string $class = 'stdClass', bool $columnHeaders = true): object
    {
        $object = new $class();
